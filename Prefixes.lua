...
local KNOWN_PREFIXES = {
	...
	["ATT"]						= "AllTheThings",
	["ATTC"]					= "AllTheThings",
	["ATTop31ms337x"]			= "Arena Team Tracker",
	["ATTm4d4f4k4l0"]			= "Arena Team Tracker",
	["ATTl0lz3r1n4h"]			= "Arena Team Tracker",
	["AVR"]						= "Augmented Virtual Reality",
	["AVRE-1.0"]					= "AVR Encounters",
	["AAPChat"]						= "Azeroth Auto Pilot",
	...
	["AOKEYSTONES2"]				= "AO Keystones", -- BfA
	["ArenaMaster"]					= "Arena Master",
	["ArenaUnitFrames"]				= "Arena Unit Frames",
	["Armory"]					= "Armory",
	["AstralKeys"]					= "Astral Keys", -- also used for compatibility Reasons by REKeys-Keystone Manager && nKeys
	...
	["BDLC"]					= "Big Dumb Loot Council",
	["BeastTraining"]				= "BeastTraining",
	["BGE"]						= "BattleGroundEnemies",
	["BigBrother"]					= "Big Brother",
	["BigWigs"]					= "BigWigs",
	["BossNotes"]					= "Boss Notes",
	["brmtRE"]						= "Brewmaster Tools",
	...
	["Cap"]						= "Capping Battleground Timers",	-- v3.2.002+ new IoC siege sync
	["Capping"]					= "Capping Battleground Timers",
	...
	["GM2SD"]					= "GatherMate2",
	["GMSD"]					= "GatherMate1",
	["GRMUSER"]					= "Guild Roster Manager",
	["GRMVER"]					= "Guild Roster Manager",
	--["GRM_ALTSYNCUP"]			= "Guild Roster Manager",
	--["GRM_BANSYNCUP"] 			= "Guild Roster Manager",
	--["GRM_BDSYNCUP"]			= "Guild Roster Manager",
	--["GRM_CUSTSYNCUP"]			= "Guild Roster Manager",
	--["GRM_JDSYNCUP"]			= "Guild Roster Manager",
	--["GRM_MAINSYNCUP"]			= "Guild Roster Manager",
	--["GRM_PDSYNCUP"]			= "Guild Roster Manager",
	--["GRM_REMSYNCUP"]			= "Guild Roster Manager",
	["GRM_SYNC"]				= "Guild Roster Manager",
	["GRoster"]					= "GuildRoster",
	["GS4x_Data"]					= "GearScore",
	["GS4y_Data"]					= "GearScore",
	["GSE"]							= "Gnome Sequence Enhancer",
    ...
    ["GottaGoFastCM"]				= "GottaGoFast",
	["GGFHistory"]					= "GottaGoFast",
	["GK"]							= "Guild Keys",
    ["GottaGoFastTW"]				= "GottaGoFast",
	...
	["HermesR1"]					= "Hermes",
	["HermesS1"]					= "Hermes",
	["HNA"]							= "HandyNotes_Argus", -- the one by nefine
	["IFTHEN"]						= "IfThen",
	["iLib"]						= "iLib", -- used by multiple Addons
	["IRT_HA"]						= "Infine Raid Tools",
	["IRT_HD"]						= "Infine Raid Tools",
	["IRT_INNERVATE"]				= "Infine Raid Tools",
	["IRT_INTERRUPT"]				= "Infine Raid Tools",
	["IRT_LID"]						= "Infine Raid Tools",
	["IRT_SLUDGEFIST"]				= "Infine Raid Tools",
	["IRT_TCOB"]					= "Infine Raid Tools",
	["IRT_UPDATE"]					= "Infine Raid Tools",
	["IRT_VC"]						= "Infine Raid Tools",
	...
	["KALIFCMSG"]					= "Forecast",
	["KARMA"]					= "Karma",
	["KCLib"]					= "Keystone Communication Library", -- primarily used in Keystone Roll-Call
	["KeyCom_Key"]				= "Keystone Commander",
	["KeystoneQuery2"]			= "KeystoneQuery",
	["KeyedLib"]				= "Keyed",	-- Keyed <=1.4.9 (Legion)
	["KeyedLib_2"]				= "Keyed",	-- Keyed 1.4.10+ (8.01 bfa)
	["KeystoneManager"]			= "Keystone Manager",
	["KHP_deamon"]					= "Kalecgos Dual HP",
	["KHP_dragon"]					= "Kalecgos Dual HP",
	["KLHALG"]					= "KLHAlgalon",
	["KLHTM"]					= "KLHThreatMeter",
	["KRC-MSG"]					= "Keystone Roll-Call",
	["KRC-VC"]					= "Keystone Roll-Call",
	...
	["LHNoCh"]					= "LootHelper",
	["LHRAward"]				= "LootHelper",
	["LHRBRelic"]				= "LootHelper",
	["LHRBToken"]				= "LootHelper",
	["LHRButtons"]				= "LootHelper",
	["LHRCancel"]				= "LootHelper",
	["LHRChange"]				= "LootHelper",
	["LHRCheck"]				= "LootHelper",
	["LHRDice"]					= "LootHelper",
	["LHRLock"]					= "LootHelper",
	["LHRLockR"]				= "LootHelper",
	...
	["LHRStart"]				= "LootHelper",
	["LHVCH"]					= "LootHelper",
	["LibSpec"]					= "LibSpecialization", -- by funkehdude
	...
	["LRS"]						= "Open-Raid-Library", -- used mostly by Details
	["LUI_Version"]					= "LUI",
	["MARYSUE"]					= "MarySue",
	...
	["MAZEHELPER"]					= "Maze Helper (Mists of Tirna Scithe)",
	["MeBo"]					= "MessageBoard",	-- most likely
	["MorgBid2"]					= "MorgBid2",
	["MorgDKP2MorgBid"]				= "MorgDKP2",
	["MorgDKP2Syncing"]				= "MorgDKP2",
	["MOTSH"]						= "Mists of Tirna Scithe Helper (MOTSH)", -- also used by Maze Helper (Mists of Tirna Scithe)
	["MrtWooVer"]					= "MrtWoo",
	["MultiBoxer"]					= "MultiBoxer",
	["MYTHICAUTOMARK"]				= "Mythic+ Automarker - Dragonflight Season 1", -- WeakAura https://wago.io/1ctv3b91K
	["NECB"]					= "Natur EnemyCastBar",
	["NECBCHAT"]					= "Natur EnemyCastBar",
	["NECBCTRA"]					= "Natur EnemyCastBar",
	["NickTag"]						= "NickTag", -- library that is so far only found in Details damage meter
	["nKeys"]						= "nKeys",
	["NKEYSTONE"]					= "NKeystone",
	["Nurfed:Lyt"]					= "Nurfed Layout",
	["OmniCD"]						= "OmniCD",
	["OMNICD_VERSION"]				= "OmniCD",
	["OpenRaid"]					= "OpenRaid",
	["Ovale"]					= "Ovale",
	["OQ"]						= "oQueue",
	...
	["PABop31ms337x"]				= "Party Ability Bars", -- by Schaka for Legion 
	["PABm4d4f4k4l0"]				= "Party Ability Bars", -- by Schaka for Legion
	["PABl0lz3r1n4h"]				= "Party Ability Bars", -- by Schaka for Legion
	["PALB"]					= "Paladin Buffer",
	["PGF_VERSIONCHECK"]		= "Premade Group Finder",
	["PLH"]						= "Personal Loot Helper",
	["PLPWR"]					= "PallyPower",
	["PLRCHECK"]				= "PersoLootRoll",
	["PLRENABLE"]				= "PersoLootRoll",
	["PLRML-ASK"]				= "PersoLootRoll",
	["PLRSYNC"]				= "PersoLootRoll",
	["PLRSTATUS"]				= "PersoLootRoll",
	["PLRVERSION"]				= "PersoLootRoll",
	...
	["RaidForge"]					= "RaidForge",
	["RankWatch"]					= "RankWatch",
	["REKeys"]					= "REKeys", -- also registering AstralKeys
	["RSA"]						= "Raeli's Spell Announcer",
	["RSA_Status"]				= "Raeli's Spell Announcer",
	["RSA_Version"]				= "Raeli's Spell Announcer",
	["RCLC"]					= "RCLootCouncil",
	["RCLCv"]					= "RCLootCouncil",
	["RCLCs"]					= "RCLootCouncil",
	...
	["TRP3.1"]					= "Total Role Play", --version 3.1
	["TRP3.2"]					= "Total Role Play", --version 3.2
	["TR_K"]					= "Totem Radius",
	["TR_L"]					= "Totem Radius",
	["TSK"]						= "TeamSqueak",
	["Talented"]					= "Talented",
	["Thr"]						= "Threat-1.0",
	["TIRNASCYTHE"]				= "WA:Mists of Tirna Scithe maze guessing game", -- also used by Maze Helper (Mists of Tirna Scithe)
	...
	["WeakAurasProg"]			= "WeakAuras 2",
	["WGA"]						= "Wintergrasper Advanced",
	["WGTime"]					= "Capping",	-- Wintergrasp-Sync
	["Whizzey"]					= "Instance Achievement Tracker",
	["WhoTaunted_Versi"]		= "Who Taunted?",
	...
	["WQPartyFinder"]			= "World Quest Party",
	["X-Perl"]					= "X-Perl",
	["X-PerlHeal"]					= "X-Perl",
	["XChar"]					= "XChar-Profiler",
	["YRT2"]					= "YamRaidTracker2",
	["Yacl"]					= "YACL-DmgMeter",
	["ZenTracker"]				= "ZenTracker", -- WeakAura based cooldown tracker
	["ZPerlVersion"]			= "ZPerl",
	["zygor7sync"]				= "ZygorGuides",	-- ZygorGuidesViewer7 introduced this
	["[HA]"]					= "HealAssign",
	["[Spy]"]					= "Spy",
